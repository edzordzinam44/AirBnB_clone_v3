...
class Test_FileStorage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        test_args = {'updated_at': datetime(2024, 4, 4, 10, 26, 21, 477863),
                     'id': 'f519fb40-1f5c-458b-945c-2ee8eaaf4900',
                     'created_at': datetime(2024, 4, 4, 10, 26, 21, 477863)}
...
# should test with a bad class name
    ...
    def test_state(self):
        ...
        a = State(name="HopeFab", id="HopeFab99")
        a.save()
        self.assertIn("HopeFab99", self.store.all("State").keys())
